...
class AICodeDetector {
    ...
    displayResults(result) {
        ...
        // Show nuanced label if present
        let nuancedLabelDiv = this.predictionResult.querySelector('.nuanced-label');
        if (!nuancedLabelDiv) {
            nuancedLabelDiv = document.createElement('div');
            nuancedLabelDiv.className = 'nuanced-label';
            predictionText.parentNode.insertBefore(nuancedLabelDiv, predictionText.nextSibling);
        }
        if (result.nuanced_label) {
            nuancedLabelDiv.textContent = `Nuanced Label: ${result.nuanced_label}`;
            nuancedLabelDiv.style.display = 'block';
        } else {
            nuancedLabelDiv.style.display = 'none';
        }
