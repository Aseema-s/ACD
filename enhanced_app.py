...
def analyze_code():
    try:
        ...
        # If model.py's predict_code_type is used, it returns 'nuanced_label'
        nuanced_label = prediction_result.get('nuanced_label', None)
        ...
        if nuanced_label is not None:
            response['nuanced_label'] = nuanced_label
